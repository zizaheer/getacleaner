            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="breadcrumb-text">
                        <h1 class="breadcrumb-title">Estimation</h1>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control" id="areaToBeCleaned">
                                ...
                                <option value="2">1001 - 1500</option>
                                <option value="3">1501 - 2000</option>
                                <option value="4">2001 - 2500</option>
                                <option value="5">3001 - 3500</option>
                                <option value="6">2501 - 3000</option>
                                <option value="7">3001 - 3500</option>
                                <option value="8">3501 - 4000</option>
                                <option value="9">4001 - 4500</option>
                            </select>
                            </div>
                        ...
                        <label for="frequency" class="col-sm-4 col-form-label">Frequency</label>
                            ...
                            -->
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="frequency" id="freqWeekly" value="W" checked>
                                <label class="form-check-label" for="freqWeekly">Weekly</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="frequency" id="freqFortnightly" value="F">
                                <label class="form-check-label" for="freqFortnightly">Fortnightly</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="frequency" id="freqMonthly" value="M">
                                <label class="form-check-label" for="freqMonthly">Monthly</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="frequency" id="freqOnce" value="O">
                        ...
                        <div class="form-group row" id="divMovingInOut" style="display: none;">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="movingInOutCleaning" value="3" disabled>
                        ...
                        <label for="days" class="col-sm-4 col-form-label">Day/s</label>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="monday" value="Mon" checked>
                                <label class="form-check-label" for="monday">Mon</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="tuesday" value="Tue" checked>
                                <label class="form-check-label" for="tuesday">Tue</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="wednesday" value="Wed" checked>
                                <label class="form-check-label" for="wednesday">Wed</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="thursday" value="Thu" checked>
                                <label class="form-check-label" for="thursday">Thu</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="friday" value="Fri" checked>
                                <label class="form-check-label" for="friday">Fri</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="saturday" value="Sat" checked>
                                <label class="form-check-label" for="saturday">Sat</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="sunday" value="Sun" checked>
                        ...
                        <label for="cleaningType" class="col-sm-4 col-form-label">Type</label>
                            <div class="col-sm-8">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="cleaningType" id="regularCleaning" value="1" checked>
                                    <label class="form-check-label" for="regularCleaning">Regular cleaning</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="cleaningType" id="deepCleaning" value="2">
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="your-order mb-30 ">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-sm-2 col-form-label" id="lblHourlyRate">$00.00</label>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-8 col-form-label">Estimated hours</label>
                                <label class="col-sm-2 col-form-label" id="lblEstimatedHour">0.00</label>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-8 col-form-label">Additional service</label>
                                <label class="col-sm-2 col-form-label" id="lblAdditionalServiceCharge">0.00</label>
                            </div>
                            <hr>
                            <div class="form-group row">
                                <label class="col-sm-8 col-form-label"><h5>Estimated charge</h5></label>
                                <label class="col-sm-2 col-form-label" id="lblEstimatedCharge"><h5>$000.00</h5></label>
                            </div>
                            <hr>
